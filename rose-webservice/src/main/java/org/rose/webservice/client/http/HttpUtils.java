...
public class HttpUtils {
    ...
    public static String getQueryString(Map<String, Object> paramters, String charset) throws UnsupportedEncodingException {
        ...
        for (String parameterName : paramters.keySet()) {
            Object parameterValue = paramters.get(parameterName);
     ...
     * @see com.derby.dswitch.common.webservice.client.http.HttpConnection
     */
