 ...
 *       &lt;sequence>
 *         &lt;element name="hotelNos" type="{http://schemas.microsoft.com/2003/10/Serialization/Arrays}ArrayOfstring" minOccurs="0"/>
...
@XmlRootElement(name = "GetHotelsByHotelNos")
public class GetHotelsByHotelNos {

    @XmlElementRef(name = "hotelNos", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<ArrayOfstring> hotelNos;
    ...
    /**
     * Gets the value of the hotelNos property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<ArrayOfstring> getHotelNos() {
        return hotelNos;
    }

    /**
     * Sets the value of the hotelNos property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfstring }{@code >}
     *     
     */
    public void setHotelNos(JAXBElement<ArrayOfstring> value) {
        this.hotelNos = ((JAXBElement<ArrayOfstring> ) value);
    }
