 ...
 *         &lt;element name="Gender" type="{http://www.w3.org/2001/XMLSchema}unsignedByte" minOccurs="0"/>
...
public class Guest {
    ...
    @XmlElementRef(name = "Email", namespace = "http://schemas.datacontract.org/2004/07/NextPms.PublicService.Model.Order", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "Gender", namespace = "http://schemas.datacontract.org/2004/07/NextPms.PublicService.Model.Order", type = JAXBElement.class)
    protected JAXBElement<Short> gender;
    ...
    @XmlElementRef(name = "Nationality", namespace = "http://schemas.datacontract.org/2004/07/NextPms.PublicService.Model.Order", type = JAXBElement.class)
     ...
     *     
     */
    public JAXBElement<Short> getGender() {
        return gender;
    }
     ...
     *     
     */
    public void setGender(JAXBElement<Short> value) {
        this.gender = ((JAXBElement<Short> ) value);
    }
