 ...
 *       &lt;sequence>
 *         &lt;element name="changeStayRequest" type="{http://schemas.datacontract.org/2004/07/NextPms.PublicService.Model.Order}ChangeStayRequest" minOccurs="0"/>
...
@XmlRootElement(name = "ChangeStay")
public class ChangeStay {

    @XmlElementRef(name = "changeStayRequest", namespace = "http://tempuri.org/", type = JAXBElement.class)
    protected JAXBElement<ChangeStayRequest> changeStayRequest;
    ...
    /**
     * Gets the value of the changeStayRequest property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ChangeStayRequest }{@code >}
     *     
     */
    public JAXBElement<ChangeStayRequest> getChangeStayRequest() {
        return changeStayRequest;
    }

    /**
     * Sets the value of the changeStayRequest property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ChangeStayRequest }{@code >}
     *     
     */
    public void setChangeStayRequest(JAXBElement<ChangeStayRequest> value) {
        this.changeStayRequest = ((JAXBElement<ChangeStayRequest> ) value);
    }
