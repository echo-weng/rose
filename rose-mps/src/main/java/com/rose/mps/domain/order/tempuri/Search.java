 ...
 *       &lt;sequence>
 *         &lt;element name="searchRequest" type="{http://schemas.datacontract.org/2004/07/NextPms.PublicService.Model.Order}SearchRequest" minOccurs="0"/>
...
public class Search {
    ...
    protected JAXBElement<SearchRequest> searchRequest;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link SearchRequest }{@code >}
     *     
     */
    public JAXBElement<SearchRequest> getSearchRequest() {
     ...
     *     
     */
    public void setSearchRequest(JAXBElement<SearchRequest> value) {
        this.searchRequest = ((JAXBElement<SearchRequest> ) value);
    }
